          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4 text-amber-900 shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="mt-0.5 text-xs text-amber-700">
                  ກະລຸນາລະບຸ ສາງ, ຕູ້, ຊັ້ນ ຫຼື ແຟ້ມເອກະສານ ເພື່ອຄວາມສະດວກໃນການຄົ້ນຫາ ແລະ ຈັດການເອກະສານຕົວຈິງ
                </div>
              </div>
            </div>
            <button
                  ...
                  <dd className="text-right text-gray-900">
                    {doc.warehouseName || doc.cabinetName || doc.shelfName || doc.folderName ? (
                      ...
                      <button
                        type="button"
                        onClick={() => setStorageOpen(true)}
                        className="inline-flex items-center gap-1.5 rounded-full bg-amber-50 border border-amber-300 px-2.5 py-0.5 text-xs font-medium text-amber-800 hover:bg-amber-100 hover:border-amber-400 transition"
                        title="ກົດເພື່ອເລືອກບ່ອນຈັດເກັບໃນຄັງ"
                      >
                        <span className="inline-block h-1.5 w-1.5 rounded-full bg-amber-500 animate-pulse" />
                        <span>⚠️ ຍັງບໍ່ມີບ່ອນເກັບ</span>
                        <span className="text-[11px] underline font-semibold text-amber-900">+ ເລືອກບ່ອນເກັບ</span>
                      </button>
                    )}
                  </dd>
                </div>
